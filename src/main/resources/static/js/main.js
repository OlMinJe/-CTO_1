...
addToDo.addEventListener('click', function(){    // 버튼에 클릭 이벤트가 발생하면
    ...
    if (!inputBox.value)            // 할 일 입력창에 내용이 입력되지 않으면 alert 발생
        ...
        list.innerHTML = '<input type="checkbox" class="list_check" name="list_check" value="list_check"><label for="list_check" style="margin: 0 10px;">' +
            inputBox.value + '</label>';  // <li>입력된 할 일</li>
